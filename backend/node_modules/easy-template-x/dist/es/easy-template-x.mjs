...
class Docx {
  ...
  async getHeaderOrFooter(type) {
    ...
    const sectionProps = this.allSectionProperties(docRoot);
  ...
  allSectionProperties(docRoot) {
    ...
    if (lastSectionProps) {
      sectionProps.push(lastSectionProps);
    }
    return sectionProps;
  }
}
